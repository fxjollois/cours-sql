...
Enfin, la table **`Séances`** décrit l'ensemble des séances hebdomadaires du club. Chacune concerne un sport, dans un gymnase, par un entraineur, sur un horaire spécifique d'un jour de la semaine. Les horaires sont stockées de telle sorte que `19.3` veut dire `"19h30"`. Les durées sont en minutes. 
