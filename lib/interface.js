...
(function () {
    ...
    function debut() {
        ...
        $("#tables").css("visibility", "hidden")
            .removeClass("active");
        choix.append($("<button>").html("1 - Requêtage simple").click(function () { lancementCours("1-requetage-simple"); }));
        choix.append("<br>");
        choix.append($("<button>").html("2 - Calculs et fonctions").click(function () { lancementCours("2-calculs-fonctions"); }));
        choix.append("<br>");
        choix.append($("<button>").html("3 - Agrégats").click(function () { lancementCours("3-agrégats"); }));
        choix.append("<br>");
        choix.append($("<button>").html("4 - Jointures").click(function () { lancementCours("4-jointures"); }));
        choix.append("<br>");
        choix.append($("<button>").html("5 - Sous-requêtes").click(function () { lancementCours("5-sous-requetes"); }));
        choix.append("<br>");
        choix.append($("<button>").html("6 - Opérations ensemblistes").click(function () { lancementCours("6-ensemblistes"); }));
        choix.append("<br>");
